...
public class TicketService {
    ...
    public void vehiculoConMasTickets() {
        if (tickets.isEmpty()) { System.out.println("No hay tickets."); return; }
        Map<String, Integer> conteo = new HashMap<>();
        for (Ticket t : tickets)
            conteo.put(t.getVehiculo().getPlaca(), conteo.getOrDefault(t.getVehiculo().getPlaca(), 0) + 1);
        ...
        System.out.println("Placa: " + placaTop + " - Tickets: " + maxVal);
    }
    ...
    private List<Ticket> cargarTicketsEnMemoria() {
        ...
        for (String[] fila : datos) {
            try {
                ...
                System.out.println("Advertencia: no se pudo cargar un ticket.");
            }
        }
        return lista;
    }
